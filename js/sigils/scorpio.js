...
SIGIL_DEFS.scorpio = {
        ...
        buffs: [
            ...
            { id: 'tu_huyet', name: 'Death Mark', type: 'ATK', typeC: '#ef4444',
              desc: 'HP 100%→21%: +0%→+50% damage linearly. HP ≤20%: +65% damage from all sources. HP ≤5%: lightning instakill. Skill F blade arc pierces Iron Body. Enemies below 50% HP show a cyan warning ring.' },
        ]
};
...
SIGIL_I18N_VI.scorpio = { name: 'Bọ Cạp', element: 'Thủy', buffs: {
        ...
        tu_huyet: { name: 'Tử Ấn', desc: 'HP 100%→21%: sát thương tăng tuyến tính +0%→+50%. HP ≤20%: +65% sát thương từ mọi nguồn. HP ≤5%: sét đánh kết liễu ngay lập tức. Vòng cung lưỡi kiếm Skill F xuyên qua Iron Body. Kẻ địch dưới 50% HP hiện vòng cảnh báo màu xanh cyan.' },
}};
