...
SIGIL_DEFS.aquarius = {
        ...
        buffs: [
            ...
            { id: 'dien_tu_truong', name: 'Magnetic Field', type: 'DEF', typeC: '#3b82f6',
              desc: 'While Skill G is active or fully charged, enemies within 300px are slowed 30% and suffer 91 DoT every 100ms (910/s)' },
        ]
};
...
SIGIL_I18N_VI.aquarius = { name: 'Bảo Bình', element: 'Phong', buffs: {
        ...
        dien_tu_truong: { name: 'Điện Từ Trường', desc: 'Trong lúc Skill G kích hoạt hoặc nạp đầy, kẻ địch trong bán kính 300px bị chậm 30% và chịu 91 sát thương mỗi 100ms (910/s)' },
}};
