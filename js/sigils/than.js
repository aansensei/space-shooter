...
SIGIL_DEFS.than = {
        ...
        buffs: [
            ...
            { id: 'bien_hoa_72', name: '72 Transformations', type: 'ATK', typeC: '#ef4444',
              desc: 'While holding 3 different gems at once, every stolen attack unleashed hits 1.65x as hard - the Great Sage\'s full mastery of borrowed powers, "72 Transformations" for whatever the moment demands.' },
        ]
};
...
SIGIL_I18N_VI.than = { name: 'Đấu Chiến Thắng Phật', element: 'Thổ', buffs: {
        ...
        bien_hoa_72: { name: '72 Phép Biến Hóa', desc: 'Khi đang giữ đủ 3 viên bảo thạch khác loại, mỗi đòn cướp được tung ra sẽ mạnh hơn x1.65, thể hiện trọn vẹn khả năng "72 phép biến hóa" của Tề Thiên, sẵn sàng ứng biến mọi tình huống.' },
}};
