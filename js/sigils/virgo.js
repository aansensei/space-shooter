...
SIGIL_DEFS.virgo = {
        ...
        buffs: [
            { id: 'mui_ten_vang', name: 'Forest Guardian', type: 'ATK', typeC: '#ef4444',
              desc: 'Every 6th auto volley triggers a Critical Strike: 3x damage, Vulnerability, root + silence 1s. Bullets glow gold. While 5+ enemies are on screen, every 4s a vine-wrapped wooden fist sweeps across the screen (60% of screen width), dealing 2100 + 10% of each target\'s lost HP.' },
...
SIGIL_I18N_VI.virgo = { name: 'Xử Nữ', element: 'Thổ', buffs: {
        mui_ten_vang: { name: 'Hộ Lâm', desc: 'Mỗi đợt bắn tự động thứ 6 kích hoạt Chí Mạng: sát thương x3, gây Trọng Thương, trói + câm lặng 1s. Đạn phát sáng vàng. Khi có 5+ kẻ địch trên màn hình, mỗi 4s 1 nắm đấm gỗ bọc dây leo quét ngang màn hình (60% chiều rộng màn hình), gây 2100 + 10% HP đã mất của mỗi mục tiêu.' },
