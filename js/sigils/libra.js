...
SIGIL_DEFS.libra = {
        ...
        buffs: [
            { id: 'mui_ten_apollo', name: "Blood Arrow", type: 'SPEC', typeC: '#f59e0b',
              desc: 'Skill A cooldown -2s while Libra is equipped. Skill A banks a stack per press; press again with a target to trigger the charge and release everything banked, each firing 5 piercing arrows (1 big marking the highest-MaxHP enemy, 4 small on other enemies, denser clusters preferred). The big arrow pierces for 300 dmg and explodes as true damage for 400+20% Max HP (up to +120% more from DR); small arrows pierce for 180 and explode as piercing damage (still blocked by shield) for 180+12% Max HP plus 5% of the target\'s already-lost HP, but fly 20% faster. Explosions apply 2 Vulnerability stacks; a repeat hit on the same enemy deals 30% less.' },
