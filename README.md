...
- The big arrow **pierces all enemies** it passes through for **300 base damage**, then **explodes** on its own marked target for **400 base + 20% of the target's Max HP**, scaled up by the target's estimated damage reduction (up to **+100%** more against very tanky targets).
- The 4 small arrows pierce for **180 base damage** and explode for a flat **160 base + 10.5% of the target's Max HP** (same DR scaling as the big arrow applies), but fly **20% faster**; the big arrow is **15% bigger** than the small ones.
