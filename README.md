...
- Every arrow **pierces all enemies** it passes through for **300 base damage**, then **explodes** on its own marked target for **400 base + 20% of the target's Max HP**, scaled up by the target's estimated damage reduction (up to **+100%** more against very tanky targets). The explosion applies **2 Vulnerability stacks**.
- The 4 small arrows deal **40% less damage** than the big one but fly **20% faster**; the big arrow is **15% bigger** than the small ones.
